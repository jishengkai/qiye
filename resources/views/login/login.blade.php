...
<div class="music-lgin">
    ...
    <div class="music-lgin-text">
        <input class="inputname inputs" type="text" name="uname" id="uname" placeholder="用户名" value="admin"/>
    </div>
    <!--2-->
    <div class="music-lgin-text">
    ...
    <div class="music-lgin-text" >
       <input type="text"  placeholder="验证码" id="code" class="music-qd inputs" style="width: 100px"><img src="http://www.qiye.com/code" id='codes' alt="" width="120px">
    </div>
    <!--3-->
    <div class="music-lgin-text">
    ...
    <div class="music-lgin-text">
        <a href="/login/reg"><input class="music-qd inputs" type="button" value="注册"   /></a>
    </div>
